...
public abstract class StoppableThread extends Thread {
     ...
     * restart the process itself to ensure they are freed.
     *
     * TODO: It would be nice if we could supply an indication in the EFE itself
     * so that a process could exit if it found itself in that state.
     *
