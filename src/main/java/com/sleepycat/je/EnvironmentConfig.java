...
public class EnvironmentConfig extends EnvironmentMutableConfig {
     ...
     * true. Btree verification will be added in a future release.
     * <p>
     ...
     * <p>
     * If isCorrupted returns true, a network restore (or restore from backup)
     ...
     * record (the log sequence number, or LSN) is is checked to ensure that
    ...
    /**
     * Configures the default lock timeout. Equivalent to setting the
     * {@link #LOCK_TIMEOUT} property. The default value is 500ms. It may be
     * overridden on a per-transaction basis by calling
