...
public class CursorImpl implements Cloneable {
     ...
     * than "data" only if "data" is partial.
     *
     * @return pair of OperationResult and 'inserted' boolean.
     * OperationResult is null only if an expired LN was purged and a partial
     * 'data' param was supplied.
     */
    public Pair<OperationResult, Boolean> insertOrUpdateRecord(
        ...
        try {
            ...
            if (insertResult.second() != null) {
                inserted = true;
                success = true;
                return new Pair<>(insertResult.second(), true);
            }
